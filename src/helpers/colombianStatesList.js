export const colombianStatesList = [
  {
    ...
    value: "NN",
    urlFlag: process.env.PUBLIC_URL + "/assets/common/emptyImage.png",
  },
  {
    id: 2,
    name: "Amazonas",
  ...
  },
  {
    ...
    value: "SAN_ANDRES_Y_PROVIDENCIA",
    urlFlag:
...
export const getColombianStateNameByValue = (value) =>
  colombianStatesList.find((colombianState) => colombianState.value === value)
    .name;

export const getColombianStateValueByName = (name) =>
  colombianStatesList.find((colombianState) => colombianState.name === name)
    .value;

export const getColombianStateFlagByValue = (value) =>
  colombianStatesList.find((colombianState) => colombianState.value === value)
    .urlFlag;
